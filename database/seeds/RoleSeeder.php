...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role_admin->permissions = [
            ...
            'biomedical.list' => true,
            'biomedical.create' => true,
            'biomedical.update' => true,
            'biomedical.delete' => true,
            'biomedical.view' => true,
        ...
        // biomedical permission add
        $role_biomedical = Sentinel::findRoleBySlug('biomedical');
        $role_biomedical->permissions = [
            'doctor.list' => true,
            'doctor.create' => true,
            'doctor.view' => true,
            'doctor.update' => true,
