                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body pt-0">
                            <div class="d-md-flex justify-content-md-center align-items-md-center p-3">
                                <div class="col-md-6">
                                    <img src="{{ asset('assets/images/token-expired.svg') }}" class="img-fluid" alt="token-invalido">
                                </div>
                                <div class="col-md-6">
                                    <h3 class="text-primary font-weight-bold">Token Expirou!</h3>
                                    <p>O token expirou por tempo de inatividade! Caso queira recuperar a senha de acesso novamente, <a href="{{ route('forgot.password') }}" class="font-weight-medium text-primary">Clique aqui</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
