...
@section('title') Cadastrar notícia @endsection
...
@section('content')
    ...
    <div class="row card p-4 rounded-lg shadow">
        <div class="col-lg-12 px-0">
            <form action="{{ route('dash.posts.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex">
                                <input type="date" class="form-control rounded-lg" name="registered_at" value="{{ old('registered_at', date('Y-m-d')) }}" required>
                                <input type="time" class="form-control rounded-lg" name="hour" value="{{ old('hour', date('H:i')) }}" required>
                            </div>
                        </div>
                        <div class="mb-3">
