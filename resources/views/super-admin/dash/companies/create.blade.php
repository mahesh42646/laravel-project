...
@section('title') Nova Empresa @endsection
...
@section('content')
    ...
    <div class="row card p-4 rounded-lg shadow">
        <div class="col-lg-12 px-0">
            <form action="{{ route('dash.companies.store') }}" method="POST">
                @csrf
                <h4 class="text-dark font-weight-bold mb-3">Nova empresa</h4>
                ...
                <div class="row">
                    <div class="col-md-9 mb-3">
                        ...
                        <input type="text" name="responsible" class="form-control text-uppercase rounded-lg" value="{{ old('responsible') }}" required>
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-9 mb-3">
                        ...
                        <input type="text" name="address" class="form-control rounded-lg" value="{{ old('address') }}">
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control rounded-lg" name="observation" rows="2">{{ old('observation') }}</textarea>
                </div>

                {{-- BOTOES DE VOLTAR E SALVAR --}}
                <div class="d-md-flex justify-content-md-between align-items-md-center mt-3">
                    <a href="{{ route('dash.companies.index') }}" class="btn btn-light font-weight-semibold rounded-lg px-4 waves-effect mb-0">
