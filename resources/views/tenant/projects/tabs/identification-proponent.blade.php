<div class="tab-pane fade show active" id="identification-proponent" role="tabpanel">
    <div class="d-md-flex justify-content-md-between align-items-md-center mb-4">
        <h5 class="mb-0">Identificação do proponente</h5>

        <div class="d-flex">
            <a href="{{ route('projects.tabs.customer.print', $project->id) }}" target="_blank" 
            ...
            <div class="d-flex align-items-center ml-3">
                <button type="button" class="rounded-lg bg-white px-3 py-1"
                    data-toggle="modal" data-target="#identificationProponentTimelineModal" style="border: 1px solid #CCC;"
                >
                ...
                <div class="modal fade" id="identificationProponentTimelineModal" tabindex="-1" role="dialog" aria-labelledby="warningTitle" aria-hidden="true">
                            ...
                            <div class="modal-body px-4 pb-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="font-weight-medium font-size-16 text-dark">Timeline da identificação do proponente</span> 
                                    </div>
                                ...
                                <div class="d-flex flex-column card p-3 mb-3" style="border-radius: 15px; border: 1px solid #d9d7d7;">
                                    <ol class="timeline">
                                        @foreach ($project->identification_proponent->timelines as $timeline)
    ...
    @if ($customer->agent_pf_id)
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->name }}" readonly>
            </div>
            <div class="col-md-3 mb-3">
                <label class="text-dark">CPF *</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->cpf }}" readonly>
            </div>
            <div class="col-md-3 pr-md-0 mb-3">
                <label class="text-dark">Data de nascimento *</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->date_of_birth?->format('d/m/Y') }}" readonly>
            </div>
        </div>
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->rg }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Nome Social</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->nickname }}" readonly>
            </div>
        </div>
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->gender_id?->getName() }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Raça *</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->breed_id?->getName() }}" readonly>
            </div>
        </div>
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->is_lgbt?->getName() }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Escolaridade *</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->schooling_id?->getName() }}" readonly>
            </div>
        </div>
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->income_masked }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Principal área de atuação *</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->area_atuation_id?->getName() }}" readonly>
            </div>
        </div>
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->area_atuation_other }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Comunidades tradicionais *</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->community_traditional_id?->getName() }}" readonly>
            </div>
        </div>

        {{-- DEFICIENCIA E BENEFICIARIO DE ALGUM PROGRAMA SOCIAL --}}
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                <label class="text-dark">Você tem deficiência PCD ?</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->is_pcd?->getName() }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Em caso sem para PCD qual ?</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->deiciency_name }}" readonly>
            </div>
        </div>

        {{-- BENEFICIARIO DE ALGUM PROGRAMA SOCIAL --}}
        <div class="d-md-flex">
            <div class="col-md-12 px-md-0 mb-3">
                <label class="text-dark">Beneficiário de algum programa social ?</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->is_beneficiary_program_social?->getName() }}" readonly>
            </div>
        </div>
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->city?->name }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Endereço completo</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->address }}" readonly>
            </div>
        </div>
        ...
        <div class="d-md-flex">
            <div class="col-md-6 pl-md-0 mb-3">
                ...
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->phone }}" readonly>
            </div>
            <div class="col-md-6 pr-md-0 mb-3">
                <label class="text-dark">Nome do responsável pelo cadastro *</label>
                <input type="text" class="form-control rounded-lg bg-light" value="{{ $pf->responsible_name }}" readonly>
            </div>
        </div>

        {{-- BOTOES DE REPROVAR, REANALISAR E APROVAR --}}
        <div class="d-flex justify-content-md-end flex-wrap mt-3">
            @if ($project->identification_proponent?->status?->getName() !== 'Em Reanálise')
                <button type="button" class="btn font-weight-medium rounded-lg px-2 py-1 ml-md-3" 
                    data-target="#customerReanalyze" data-toggle="modal" style="border: 1px solid #CCC;"
                >
            ...
            @endif
            @if ($project->identification_proponent?->status?->getName() !== 'Reprovado')
                <button type="button" class="btn font-weight-medium rounded-lg px-2 py-1 ml-md-3" 
                    data-target="#customerRepproved" data-toggle="modal" style="border: 1px solid #CCC;"
                >
            ...
            @endif
            @if ($project->identification_proponent?->status?->getName() !== 'Aprovado')
                <a href="{{ route('projects.tabs.customer.approved', $project->id) }}" 
        ...
        {{-- MODAL REPROVAR --}}
        <div class="modal fade" id="customerRepproved" tabindex="-1" role="dialog" aria-labelledby="warningTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="{{ route('projects.tabs.customer.repproved', $project->id) }}" method="POST" class="modal-body px-4 pb-4">
                        @csrf
                        @method('PUT')

                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="font-weight-semibold text-dark mb-0">
                                Analisar identificação do Proponente
                            </h5>
                            <button type="button" data-dismiss="modal" title="Fechar modal"
                                class="btn btn-dark rounded-circle d-flex align-items-center justify-content-center" 
                                style="width: 20px !important; height: 20px !important; padding: 10px"
        ...
        {{-- MODAL REANALISAR --}}
        <div class="modal fade" id="customerReanalyze" tabindex="-1" role="dialog" aria-labelledby="warningTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="{{ route('projects.tabs.customer.reanalyze', $project->id) }}" method="POST" class="modal-body px-4 pb-4">
                        @csrf
                        @method('PUT')
