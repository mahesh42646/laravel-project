        ...
        <div class="row">
            <div class="card border col-12 px-3 py-4">
                ...
                <div class="rounded-lg py-2 px-1 mb-2" style="background-color: #f3f2ff">
                    ...
                    <span class="ml-2 font-weight-medium text-primary">PJ sem fins lucrativos</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('customers.update', $customer) }}" method="POST" class="card border col-12 px-3 py-4">
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-light rounded-lg" 
                            placeholder="00.000.000/0000-00" name="cnpj" value="{{ $pjWithoutProfit->cnpj }}" required
                        >
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="text-dark">Nome da organização *</label>
                        <input type="text" class="form-control rounded-lg bg-light text-uppercase" 
                            name="organization_name" value="{{ $pjWithoutProfit->organization_name }}" required
                        >
                    </div>
                </div>
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-light rounded-lg text-uppercase" 
                            name="company_name" value="{{ $pjWithoutProfit->company_name }}" required
                        >
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="text-dark">Data da criação *</label>
                        <input type="date" class="form-control bg-light rounded-lg" name="registered_at" 
                            value="{{ $pjWithoutProfit->registered_at->format('Y-m-d') }}" required
                        >
                    </div>
                </div>
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control rounded-lg bg-light text-uppercase" 
                            value="{{ $pjWithoutProfit->representant_name }}" name="representant_name" required
                        >
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" inputmode="numeric" class="form-control bg-light rounded-lg" 
                            name="representant_cpf" value="{{ $pjWithoutProfit->representant_cpf }}" required
                        >
                    </div>
                </div>
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="w-100 form-control bg-light select2" name="city_id"  data-city>
                            <option value="{{ $pjWithoutProfit->city_id }}" selected>
                                {{ $pjWithoutProfit->city->name }}
                            </option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="text-dark">Endereço completo *</label>
                        <input type="text" class="form-control bg-light rounded-lg" name="address" value="{{ $pjWithoutProfit->address }}" required>
                    </div>
                </div>
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" inputmode="numeric" class="form-control bg-light rounded-lg" name="phone"
                            placeholder="(00) 00000-0000" value="{{ $pjWithoutProfit->phone }}" required
                        >
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-light text-uppercase rounded-lg" 
                            name="responsible_name" value="{{ $pjWithoutProfit->responsible_name }}" required
                        >
                    </div>
                </div>
