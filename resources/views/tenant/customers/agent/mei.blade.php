        ...
        <div class="row">
            <div class="card border col-12 px-3 py-4">
                ...
                <div class="rounded-lg py-2 px-1 mb-2" style="background-color: #f3f2ff">
                    ...
                    <span class="ml-2 font-weight-medium text-primary">MEI</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('customers.update', $customer) }}" method="POST" class="card border col-12 px-3 py-4">
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-light rounded-lg" 
                            placeholder="00.000.000/0000-00" name="cnpj" value="{{ $mei->cnpj }}" required
                        >
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="text-dark">Nome da organização *</label>
                        <input type="text" class="form-control rounded-lg bg-light text-uppercase" 
                            name="organization_name" value="{{ $mei->organization_name }}" required
                        >
                    </div>
                </div>
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control rounded-lg bg-light text-uppercase" 
                            value="{{ $mei->representant_name }}" name="representant_name" required
                        >
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" inputmode="numeric" class="form-control bg-light rounded-lg" 
                            name="representant_cpf" value="{{ $mei->representant_cpf }}" required
                        >
                    </div>
                </div>
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="w-100 form-control bg-light select2" name="city_id"  data-city>
                            <option value="{{ $mei->city_id }}" selected>
                                {{ $mei->city->name }}
                            </option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-light rounded-lg" name="address" value="{{ $mei->address }}" required>
                    </div>
                </div>
                ...
                <div class="d-md-flex">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" inputmode="numeric" class="form-control bg-light rounded-lg" name="phone"
                            placeholder="(00) 00000-0000" value="{{ $mei->phone }}" required
                        >
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-light text-uppercase rounded-lg" 
                            name="responsible_name" value="{{ $mei->responsible_name }}" required
                        >
                    </div>
                </div>
