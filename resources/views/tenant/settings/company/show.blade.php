...
@section('content')
    ...
    <div class="row card p-4 rounded-lg shadow">
        <div class="col-lg-12 px-0">
            <h4 class="text-dark font-weight-bold mb-3">Ver dados da prefeitura</h4>
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control bg-light rounded-lg" rows="2">{{ $tenant->observation }}</textarea>
                    </div>
                ...
                <div class="col-md-2 flex-column d-flex align-items-center justify-content-center mb-3">
                    ...
                    <img src="{{ $tenant->logo_path }}" class="w-50" data-toggle="tooltip" data-placement="top">
                </div>
            </div>
        </div>
    </div>
