<div class="px-3 pb-3" data-contrapartid-social-container>
    <div class="bg-white mb-3">
        <textarea class="form-control" name="identification_contrapartid_social" rows="5" @if ($isRequireds[11]) required @endif>
            {{ $project->identification_contrapartid_social }}
        </textarea>
    </div>
    <div data-contrapartid-social-alert></div>
    <button type="button" class="w-100 bg-white btn text-dark px-3 py-1 mb-2" style="border: 1px solid #ced4da;"
        onclick="saveContrapartidSocial(this)"
    >
