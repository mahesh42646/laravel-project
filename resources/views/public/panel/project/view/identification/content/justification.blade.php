<div class="px-3 pb-3" data-justification-container>
    <div class="bg-white mb-3">
        <textarea  class="form-control" name="identification_justification" rows="5" @if ($isRequireds[6]) required @endif>
            {{ $project->identification_justification }}
        </textarea>
    </div>
    <div data-justification-alert></div>
    <button type="button" class="w-100 bg-white btn text-dark px-3 py-1 mb-2" style="border: 1px solid #ced4da;"
        onclick="saveJustification(this)"
    >
