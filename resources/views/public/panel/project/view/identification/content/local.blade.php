<div class="px-3 pb-3" data-local-container>
    <div class="bg-white mb-3">
        <textarea class="form-control" name="identification_local" rows="5" @if ($isRequireds[12]) required @endif>
            {{ $project->identification_local }}
        </textarea>
    </div>
    <div data-local-alert></div>
    <button type="button" class="w-100 bg-white btn text-dark px-3 py-1 mb-2" style="border: 1px solid #ced4da;"
        onclick="saveLocal(this)"
    >
