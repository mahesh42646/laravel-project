<div class="d-md-flex justify-content-md-between align-items-md-center">
    ...
    <div class="d-flex" data-local-status>
        <span class="d-flex align-items-center mr-2" 
            style="border: 1px solid #ccc; border-radius: 10px; padding: 3px {{ $project->identification_local_status_id->value === 0 ? '4' : '9' }}px;"
        >
            {!! $project->identification_local_status_id->getIcon() !!}
            <span class="text-dark ml-1">{{ $project->identification_local_status_id->getName() }}</span>
        </span>
