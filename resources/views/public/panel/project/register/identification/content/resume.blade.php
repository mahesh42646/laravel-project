<div class="px-3 pb-3" data-resume-container>
    <div class="bg-white mb-3">
        <input type="hidden" name="identification_resume_status_id" value="3">
        <textarea class="form-control" name="identification_resume" rows="5" @if ($isRequireds[3]) required @endif>
            {{ $project->identification_resume }}
        </textarea>
    </div>
    <div data-resume-alert></div>
    <button type="button" class="w-100 bg-white btn text-dark px-3 py-1 mb-2" style="border: 1px solid #ced4da;"
        onclick="saveResume(this)"
    >
