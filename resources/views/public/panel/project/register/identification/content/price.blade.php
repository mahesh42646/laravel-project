<div class="px-3 pb-3" data-price-container>
    <div class="bg-white mb-3">
        <input type="hidden" data-mask-nomey-url value="{{ asset('assets/js/pages/Fill.js') }}">
        <input type="text" inputmode="numeric" class="form-control" name="identification_price" 
            value="{{ $project->identification_price ? number_format($project->identification_price, 2, ',', '.') : '' }}" @if ($isRequireds[2]) required @endif
        >
    </div>
