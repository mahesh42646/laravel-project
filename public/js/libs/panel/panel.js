(function ($) {
    ...
    function initSettings() {
        const radioButtonLight = document.querySelector('#profileLightMode');
        const radioButtonDark = document.querySelector('#profileDarkMode');
        ...
        if (window.sessionStorage) {
            ...
            if (!alreadyVisited) {
                ...
                if(alreadyVisited === 'light-mode-switch') {
                    if (radioButtonLight && radioButtonDark) {
