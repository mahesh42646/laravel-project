        ...
        `<div class="d-flex align-items-center mb-3">
            ...
            <div class="col-1">
                <label class="text-dark mb-0" style="cursor: pointer;" title="Remover mídia" onclick="this.parentElement.parentElement.parentElement.remove()">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="var(--danger)">
...
function loader(event) {
    ...
    if (! term.checked) {
        ...
        return Swal.fire({
            iconColor: 'var(--blue)',
            icon:  'info',
            title: '<span style="color: var(--blue)">Termo obrigatório!</span>',
            html: `É necessário aceitar o termo para validar sua proposta.`,
            showConfirmButton: false,
            timer: 2500,
            customClass: { htmlContainer: 'mt-1' }
        });
    ...
    setTimeout(({ target }) => {
        ...
        target.innerText = 'Enviar Proposta';
    }, 6000, event);
}
