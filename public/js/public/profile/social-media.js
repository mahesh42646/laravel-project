...
function addMedia() {
    ...
    div.innerHTML = (
        `<div class="d-flex align-items-center btn-light mb-3 p-3" style="border-radius: 10px;">
            <div class="col-5 pl-0">
                <label class="text-dark mb-1">Tipo de Mídia</label>
            ...
            <div class="col-5 px-0">
                <label class="text-dark mb-1">Link</label>
                <input type="text" class="form-control" name="media_links[]" required>
            </div>
            <div class="col-2">
                <label class="mb-1 invisible">.</label>
                <div class="d-flex align-items-center justify-content-end border-0 bg-transparent text-dark mb-0" style="cursor: pointer;" title="Remover mídia" onclick="this.parentElement.parentElement.parentElement.remove()">
                    <svg xmlns="http://www.w3.org/2000/svg" height="35" viewBox="0 -960 960 960" width="35" fill="#f61c0d">
