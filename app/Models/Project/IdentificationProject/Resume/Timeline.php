...
{
    protected $table = 'project_identification_project_resume_timelines';

    protected $fillable = [
        'identification_project_resume_id',
        'status',
        'motive',
        'customer_id',
        'analyzed_by',
    ...
    public function identification_project_resume(): BelongsTo
    {
