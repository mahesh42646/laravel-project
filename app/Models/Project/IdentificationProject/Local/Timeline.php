...
{
    protected $table = 'project_identification_project_local_timelines';

    protected $fillable = [
        'identification_project_local_id',
        'status', 
        'motive',
        'customer_id',
        'analyzed_by',
    ...
    public function identification_project_local(): BelongsTo
    {
        return $this->belongsTo(
            related: IdentificationProjectLocal::class,
