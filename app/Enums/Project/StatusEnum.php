...
enum StatusEnum: int
{
    ...
    public function getName(): string
    {
        return match($this) {
            ...
            static::SELECTED => 'Selecionado',
            static::ENABLED => 'Habilitado',
            static::SUBSTITUTE => 'Suplente',
        };
    }
    ...
    public function getIcon(): string
    {
        return match($this) {
            ...
            static::SELECTED => $this->selected(),
            static::ENABLED => $this->enabled(),
            static::SUBSTITUTE => $this->substitute(),
        };
    }
    ...
    {
        return <<<HTML
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="#50a5f1" viewBox="0 0 256 256">
    ...
    private function substitute(): string
    {
        return <<<HTML
           <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="#f1734f" viewBox="0 0 256 256">
